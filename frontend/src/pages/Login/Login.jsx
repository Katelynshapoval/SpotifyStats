  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-surface-base px-8 ">
      <div className="w-full max-w-md bg-neutral-800 text-white rounded-2xl shadow-lg p-8 flex flex-col items-center gap-6">
        ...
        <button
          onClick={() => handleLogin()}
          className="w-full flex items-center justify-center gap-3 bg-green-500 text-black font-semibold py-3 rounded-full hover:bg-green-400 transition duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-green-300 cursor-pointer"
        >
